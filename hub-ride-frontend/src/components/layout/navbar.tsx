...
import { CarFront, MapPinned, Menu } from "lucide-react";
      ...
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3" aria-label="Hub Ride home">
          ...
          <span className="flex flex-col leading-none">
            ...
            <span className="mt-1 text-xs text-muted-foreground">Future mobility</span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          <Button asChild className="hidden sm:inline-flex" size="lg">
            <Link href="/book">
              <MapPinned className="size-4" strokeWidth={1.8} aria-hidden="true" />
              Book ride
            </Link>
          </Button>
          <Button variant="outline" size="icon-lg" className="md:hidden" aria-label="Open menu">
